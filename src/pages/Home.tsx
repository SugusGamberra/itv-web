...
export default function Home() {
    return (
        <div className="flex flex-col min-h-screen w-full animate-in zoom-in-95 duration-700">
            
            <div className="flex-grow flex flex-col items-center justify-center w-full py-12">
